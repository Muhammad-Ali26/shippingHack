...
export default function PendingLabel() {
  const { data } = GetAPI("warehouse/bookings?consolidation=0&bookingStatus=7");
  ...
  pendingLabelData()?.map((value, index) => {
    return datas.push({
      serialNo: index + 1,
  ...
  return data.length === 0 ? (
    ...
    <Layout
      title={t("pages.orderManagement.titleTwo")}
      search={true}
